...
function useTypingEffect(strings: string[], typingSpeed = 80, deletingSpeed = 40, pauseTime = 2000) {
  ...
  const tick = useCallback(() => {
    ...
    if (!isDeleting) {
      ...
      if (text.length + 1 === currentStr.length) {
  ...
  }, [text, isDeleting, stringIndex, strings, pauseTime]);
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: 500,
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(79,143,255,0.12), transparent 70%)',
          top: '10%',
          left: '-5%',
          filter: 'blur(60px)',
      ...
      <div className="section-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 60, position: 'relative', zIndex: 2, flexWrap: 'wrap' }}>
        {/* Left Content */}
        <div style={{ flex: '1 1 500px', maxWidth: 600, animation: 'fadeInLeft 0.8s ease both' }}>
          <p
            style={{
              fontSize: '1.1rem',
              fontWeight: 500,
          ...
          >
            Passionate about building innovative digital experiences. I combine
            creativity with technical expertise to craft solutions that make a difference.
          </p>
          ...
          <div style={{ position: 'relative', maxWidth: 420, width: '100%' }}>
            ...
            <div
              ...
              style={{
                position: 'absolute',
                inset: '10%',
                background: 'radial-gradient(circle, rgba(79,143,255,0.15), rgba(139,92,246,0.1), transparent 70%)',
                filter: 'blur(40px)',
                borderRadius: '50%',
              }}
            />
            <img
              ...
              alt="Kethavath Anil illustration"
              loading="lazy"
              style={{
                width: '100%',
                height: 'auto',
